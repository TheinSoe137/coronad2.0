  ...
  return (
    <>
      ...
      <motion.div variants={containerVariants}
        ...
        <motion.p variants={childVariants}  className='mb-15 text-sm md:text-md lg:text-lg  lg:w-200 xl:w-300'>Nearby, a merchant market sells relics from the past: ancient weapons, shields, and wands, some of which hold untold power. While most view these items as curiosities, those who understand the Elven legacy know their true potential. These artifacts could be key in either restoring or destroying the monarchy.</motion.p>
        ...
        <motion.p  variants={childVariants} className='mb-15 text-sm md:text-md lg:text-lg lg:w-200 xl:w-300'>In the heart of the monarchy kingdom lies a mystical shop run by the enigmatic John Eolen. A man of few words and immense knowledge, John is a master craftsman of magical artifacts. His shop is a haven for those seeking powerful magical objects, many of which were once used by the Elven elders. John’s creations are more than just items; they are the keys to the Elves’ power and knowledge. Wands, enchanted capes, shields, helmets, Swords, Scrolls, Cursed Stones and orbs—each object holds a deep, ancient magic that connects the wearer to the spirits of the past.</ motion.p>

        <motion.p  variants={childVariants} className='mb-7 text-sm md:text-md lg:text-lg  lg:w-200 xl:w-300'>What few know, however, is that John is not merely a craftsman; he is a guardian of secrets, tasked with protecting the ancient artifacts of the Elven monarchy. His shop serves as both a haven and a vault, preserving items that could alter the course of history if they were ever misused.</motion.p>
